				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Survey Reports</h3>
		                              ...
		                              <?php $i=0; foreach($data['list'] as $row){ $i++; ?>
                                          ...
                                          <tr id="trrow{{$row->id}}">
											...
											<td>{{$row->status}}</td>
												...
												<td>
												<a href="<?php echo url('SurveyDetails')."?id=".$row->id?>" ><i class="flaticon-eye"></i></a>
												</td>
...
function set_edit_data(id,question_id,name,type,label,label1,label2){
