					...
					<div class="m-stack m-stack--ver m-stack--desktop">
						...
						<div class="m-stack__item m-brand  m-brand--skin-dark ">
							<div class="m-stack m-stack--ver m-stack--general">
								<div class="m-stack__item m-stack__item--middle m-brand__logo" style="width: 90% !important">
									<div class="m-brand__logo-wrapper">
										<img alt="" src="public/images/Capture.jpg" style="width: 33%;" /> &nbsp;
										<span style="color: white;font-size: 20px">Petro Fast</span>
										 ...
										 m-dropdown-toggle="click">
											<a href="#" class="m-nav__link m-dropdown__toggle">
												<span class="m-topbar__userpic">
													<img src="{{session('image')}}" class="m--img-rounded m--marginless" alt="" />
												</span>
						...
						-->
															...
															<div class="m-card-user__details">
																<span class="m-card-user__name m--font-weight-500">	{{session('name')}}</span>
																<a href="" class="m-card-user__email m--font-weight-300 m-link">	{{session('email')}}</a>
															</div>
														</div>
													</div>
													<div class="m-dropdown__body">
														<div class="m-dropdown__content">
															<ul class="m-nav m-nav--skin-light">
																...
																<li class="m-nav__item">
																	<a href="<?php echo url('logout')?>" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a>
																</li>
															</ul>
														</div>
													</div>
