				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
					...
					<div class="m-subheader ">
						<div class="d-flex align-items-center">
							<div class="mr-auto">
								<h3 class="m-subheader__title m-subheader__title--separator">Issue Types</h3>
...
<?php if(session('login_type')=="Admin"){ ?>
												<td>
													<a onclick="set_edit_data('editid','{{$row->id}}','{{$row->issue_category}}','{{$row->issue_type}}','{{$row->issue_type_ar}}')"  data-toggle="modal" data-target="#edit_modal" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit ">
...
<div class="m-portlet hidediv" id="addid" style="display: none;" >
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right" action="{{ route('IssueAdd') }}" method="post" enctype="multipart/form-data">
								<div class="m-portlet__body">
									
                                                            <div class="form-group m-form__group row">
																	<label class="col-form-label col-lg-3 col-sm-12"> Issue Category </label>
																	<div class="col-lg-4 col-md-9 col-sm-12">
																				<select class="form-control m-select2 select_class" id="category_id" name="category_id"  style="width: 100%" required="">
                                                                          <option value="">Select</option>
															...
															<div class="form-group m-form__group row">
																	<label class="col-form-label col-lg-3 col-sm-12">Issue Type</label>
																	<div class="col-lg-4 col-md-9 col-sm-12">
																				<input class="form-control" type="text" placeholder="Enter name"required name="issue_type">
																	</div>
															</div>
															
															<div class="form-group m-form__group row">
																	<label class="col-form-label col-lg-3 col-sm-12">Issue Type (Arabic)</label>
																	<div class="col-lg-4 col-md-9 col-sm-12">
																				<input class="form-control" type="text" placeholder="Enter name"required name="issue_type_ar">
																	</div>
															</div>
...
<div class="m-portlet hidediv" id="editid" style="display: none;" >
							...
							<!--begin::Form-->
							<form class="m-form m-form--fit m-form--label-align-right"  action="{{ route('IssueEdit') }}" method="post" enctype="multipart/form-data">
								<div class="m-portlet__body">


									<input type="hidden" name="issue_id_edit" id="issue_id_edit">

															<div class="form-group m-form__group row">
																	<label class="col-form-label col-lg-3 col-sm-12"> Issue Category </label>
																	<div class="col-lg-4 col-md-9 col-sm-12">
																				<select class="form-control m-select2 select_class" id="category_id_edit" name="category_id_edit"  style="width: 100%" required="">
                                                                          <option value="">Select</option>
															...
															<div class="form-group m-form__group row">
																	<label class="col-form-label col-lg-3 col-sm-12">Issue Type</label>
																	<div class="col-lg-4 col-md-9 col-sm-12">
																				<input class="form-control" type="text" placeholder="Enter name"required name="issue_type_edit" id="issue_type_edit">
																	</div>
															</div>
															...
															<div class="form-group m-form__group row">
																	<label class="col-form-label col-lg-3 col-sm-12">Issue Type (Arabic)</label>
																	<div class="col-lg-4 col-md-9 col-sm-12">
																				<input class="form-control" type="text" placeholder="Enter name"required name="issue_type_edit_ar" id="issue_type_edit_ar">
																	</div>
															</div>
...
function set_edit_data(id,issue_id,issue_category,issue_type,issue_type_ar){

$("#issue_id_edit").val(issue_id).change();
$("#category_id_edit").val(issue_category).change();
$("#issue_type_edit").val(issue_type);
$("#issue_type_edit_ar").val(issue_type_ar);
